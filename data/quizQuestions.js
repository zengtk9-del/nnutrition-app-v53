...
export const BODY_FAT_IMAGES = {
  male: {
    '3-5': require('../assets/male-3-5.jpg'),
    '6-10': require('../assets/male-6-10.jpg'),
    '11-15': require('../assets/male-11-15.jpg'),
    '16-22': require('../assets/male-16-22.jpg'),
    '23-29': require('../assets/male-23-29.jpg'),
    '30-35': require('../assets/male-30-35.jpg'),
    '36-39': require('../assets/male-36-39.jpg'),
    '40+': require('../assets/male-40-plus.jpg'),
  },
  female: {
    '10-13': require('../assets/female-10-13.jpg'),
    '14-18': require('../assets/female-14-18.jpg'),
    '19-23': require('../assets/female-19-23.jpg'),
    '24-30': require('../assets/female-24-30.jpg'),
    '31-36': require('../assets/female-31-36.jpg'),
    '37-42': require('../assets/female-37-42.jpg'),
    '43-46': require('../assets/female-43-46.jpg'),
    '47+': require('../assets/female-47-plus.jpg'),
  },
};
...
export const GOAL_IMAGES = {
  gain: require('../assets/gain_weight.jpg'),
  maintain: require('../assets/maintain.jpg'),
  lose: require('../assets/lose_weight.jpg'),
};
...
export const ACTIVITY_IMAGES = {
  barely: require('../assets/activity_barely.jpg'),
  little: require('../assets/activity_little.jpg'),
  lot: require('../assets/activity_lot.jpg'),
  super: require('../assets/activity_super.jpg'),
};
...
export const TRAINING_IMAGES = {
  none: require('../assets/training_none.jpg'),
  cardio: require('../assets/training_cardio.jpg'),
  lifting: require('../assets/training_lifting.jpg'),
  sports: require('../assets/training_sports.jpg'),
};
...
export const DIET_IMAGES = {
  balanced: require('../assets/01-balanced-standard.jpg'),
  low_carb: require('../assets/02-low-carb.jpg'),
  keto: require('../assets/03-keto.jpg'),
  low_fat: require('../assets/04-low-fat.jpg'),
  carnivore: require('../assets/05-carnivore.jpg'),
  vegan: require('../assets/06-vegan.jpg'),
  vegetarian: require('../assets/07-vegetarian.jpg'),
  pescatarian: require('../assets/08-pescatarian.jpg'),
};
